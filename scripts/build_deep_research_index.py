...
def main() -> None:
    ...
    docs_files = keep_existing(
        [
            ...
            REPO_ROOT / "docs" / "protocol" / "ai-assisted-game-design.md",
            REPO_ROOT / "docs" / "protocol" / "idena-arc-design-draft.schema.json",
            REPO_ROOT / "docs" / "protocol" / "idena-arc-ingredient-commitment.schema.json",
            REPO_ROOT / "docs" / "protocol" / "idena-arc-game-ingredient.schema.json",
            REPO_ROOT / "docs" / "protocol" / "idena-arc-game-constitution.schema.json",
