...
The idea: short human-play sessions generate reproducible traces from salted procedural ARC-style games. These traces can help train open-source adapters for ARC-style interactive reasoning agents.
